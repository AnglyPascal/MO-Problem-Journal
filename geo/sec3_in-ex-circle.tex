...
\den{Incenter and Co.}{ 
    ...
    Call $ EF $, `$ A $-tangent line', and $ DE, DF $ similarly. And call $ E_AF_A
    $ `$ A_A $-tangent line.
...
\begin{minipage}{.5\linewidth} 
    \lem{Apollonius Circle and Incenter}{
        Let $ \omega_a $ be the circle that goes through $ B, C $ and is
        tangent to $ (I) $ at $ X $. Then $ XD', EF, BC $ are concurrent and $
    ...
    \solu{[Pole-Polar]
        \href{https://artofproblemsolving.com/community/c6h17323p118682}{ISL 2002 G7}
    }
\end{minipage}\hfill% 
...
\lem{Concurrent Lines in Incenter}{
    Let $ AD \cap \odot (I) = G, AD' \cap \odot
    (I) = H $. Let the line through $ D' $ parallel to $ BC $ meet $ AB, AC $ at $
    B', C' $. Then $ AM,\ EF,\ GH,\ DD',\ BC',\ CB' $ are
    concurrent.
...
\begin{minipage}[t]{.49\linewidth}
    \figdf{.73}{concurrent_lines_in_incenter}{
...
\begin{minipage}[t]{.49\linewidth}
    \figdf{1}{InExLemma4}{
        ...
        $ AI $, $ B, I_A $-tangent lines and $ C $-mid-line are concurrent.
    } 
\end{minipage}
...
\begin{minipage}{.55\linewidth} 
    \begin{solution}[Inversion] 
        ...
        \sollem{
            $ MD $ is a line, $ I_a $ is an arbitrary point such that $
            DI_a\perp MD $. $ l $ is the perpendicular bisector of $ DI_a $. $ F,
            E $ are arbitrary points on $ l $. $ B=I_aF\cap MD, C=I_aE\cap MD\,
            H=FD\cap MI_a, K=DE\cap MI_a $. Then $ BK, CH, l $ are concurrent.
        }
