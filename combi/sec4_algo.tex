...
\dstruct{http://opendatastructures.org/versions/edition-0.1d/ods-java/node52.html}
...
\dstruct{http://www.shafaetsplanet.com/?p=763}
{Disjoint Set}{
...
\den{Minimum Spanning Tree}{
    ...
    \figdf{.4}{Minimum_spanning_tree}{Minimal Spanning Tree} 
