\newpage\section{Functional Equations}
	...
	\begin{take_note*}{}
		\begin{enumerate}[wide=0em, label=\arabic*, itemsep=10pt, parsep=5pt, font=\bfseries]
			...
			\item If you're \emph{NOT} able to make one side of the equation equal to $0$, try to make it equal to any real or some particular real. (pco 169 P11)
			
			\item Sometimes in integer functions, divisibility of the type $f(1)^{k-1}\mid f(x)^k$ helps.	
	...
	\prob{https://artofproblemsolving.com/community/c6h474746p2658967}{EGMO 2012 P3}{E}{Find all functions $f:\mathbb{R}\to\mathbb{R}$ such that \[f\left( {yf(x + y) + f(x)} \right) = 4x + 2yf(x + y)\] for all $x,y\in\mathbb{R}$.}
